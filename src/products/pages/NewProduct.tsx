...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      ...
      image:
        "https://www.officedepot.com.gt/medias/38615.jpg-1200ftw?context=bWFzdGVyfHJvb3R8Mzg4MzA1fGltYWdlL2pwZWd8aDI5L2g1ZS8xMDEzNTM0MzIwMjMzNC8zODYxNS5qcGdfMTIwMGZ0d3w3ZDE3ZGI0NGZlYjhlMDk4NDJjZjdjZjNhZWFlMDA4ODE1MDA2ZTMxZjAwODVjZmZjODBlYzBlNDBmMGUwM2Ix",
    },
  });
      ...
      <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex justify-around items-center">
          <div className="flex-col w-[500px]">
            ...
            >
              {productMutation.isPending ? "Cargando..." : "Guardar"}
            </Button>
          </div>
          ...
          >
            <Image src={newImage} alt="product" />
          </div>
        </div>
      </form>
    </div>
